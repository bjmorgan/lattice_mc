...
class LookupTableTestCase(unittest.TestCase):
    ...
    @patch(
        "lattice_mc.lookup_table.LookupTable.generate_nearest_neighbour_lookup_table"
    )
    ...
    def test_nearest_neighbour_lookup_table_is_initialised(
        self, mock_generate_nearest_neighbour_lookup_table
    ):
        hamiltonian = "nearest-neighbour"
    ...
    @patch("lattice_mc.lookup_table.metropolis")
    def test_relative_probability_with_site_energies_and_coordination_numbers(
        self, mock_metropolis
    ):
        self.table.site_energies = {"A": 1.0, "B": 2.0}
        self.table.nn_energy = 1.0
        self.table.relative_probability("A", "B", 3, 1)
    ...
    def test_generate_nearest_neighbour_lookup_table(self):
        ...
        self.table.relative_probability = Mock(
